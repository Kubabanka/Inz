...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <asp:TextBox CssClass="form-control" ID="VotersTextbox" Style="width: 100%" runat="server" TextMode="MultiLine"></asp:TextBox>
        <label for="OptionTextbox">Vote options (separated by ;):</label>
        <asp:TextBox CssClass="form-control" ID="OptionTextbox" Style="width: 100%" runat="server" TextMode="MultiLine"></asp:TextBox><br />
